...
Fundament projektu. Skupienie na czystości obrazu i geometrii.
    ...
    Geometria: Korekta perspektywy obiektu dla uzyskania poprawnej kompozycji.
...
Przekształcenie monochromatycznego obrazu w pełną barw, suwerenną wizję.
    ...
    Separacja: Izolacja poszczególnych elementów (architektura, bruk, postacie) przy użyciu narzędzi „Lasso” i „Nożyce”.
...
Finałowa faza projektu, w której autor zostaje osadzony wewnątrz wykreowanego świata.
    ...
    Integracja: Precyzyjne wycięcie sylwetki za pomocą „Nożyc” i jej przeskalowanie.
